...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Дата вылета:"))
        self.label_4.setText(_translate("Dialog", "Маршрут:"))
        self.label_5.setText(_translate("Dialog", "Клиент:"))
        self.label_6.setText(_translate("Dialog", "Номер заказа:"))
        self.label_7.setText(_translate("Dialog", "Скидка (%):"))
        self.label_8.setText(_translate("Dialog", "Код клиента:"))
